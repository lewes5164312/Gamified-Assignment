 ...
 *
 */
@Database(entities = {Note.class}, version = 1)  // Replace "Book.class" with whatever your Book entity class is.
public abstract class AppDatabase extends RoomDatabase {
    public abstract NoteDao noteDao();          // Replace BookDao with whatever you name your DAO
